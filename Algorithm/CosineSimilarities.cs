...
namespace Algorithm
{
    public class CosineSimilarities
    {
        ...
        public CosineSimilarities(List<Material> materials, ICategoriesServices categoriesServices)
        {
        ...
        public List<int> GetSimilarProducts(int materialsId, double similarityThreshold = 0.2)
        {
            ...
            {
                product.CombinedTFIDVector = descriptionTfidfVectors.ElementAt(i++).Description;
            }
            ...
            if( _productToRecommendFor != null )
            {
                var recommendedProducts = _products
                    ...
                    {
                        Product = p,
                        Similarity = CalculateCosineSimilarity(_productToRecommendFor.CombinedTFIDVector, p.CombinedTFIDVector)
                    })
